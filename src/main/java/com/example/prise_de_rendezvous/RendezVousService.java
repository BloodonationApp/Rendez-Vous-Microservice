...
public class RendezVousService {
    ...
    public int prendreRendezvous(RendezVous rendezVous, String nom, HttpServletResponse response) throws IOException, DocumentException {
        if (findByRef(rendezVous.getReference())!=null) return 0;
        else {
